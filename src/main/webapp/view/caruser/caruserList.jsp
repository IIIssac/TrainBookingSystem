        ...
        <tr>
            ...
            <td>${v.carusermanger}</td>
			  <td style="width: 180px;">
                <a href="${ctx}/caruser/edit?id=${v.caruserid}" class="layui-btn layui-btn layui-btn-sm">修改</a>
                <a href="${ctx}/caruser/delete?id=${v.caruserid}" class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
